...
export function Component({
    ...
    const animationDuration = animation ? mapRange(animation.speed, 1, 100, 1200, 80) : 1;
...
// ── Lag-free animated background ───────────────────────────────────────────────
// Pure CSS @keyframes on transform/opacity — runs on the GPU compositor thread,
// zero JS per frame. Styles live in globals.css (.eb-* classes).
